...
const packages = [
  {
    ...
    featured: false,
    features: ['Съёмка до 3 часов', 'Фильм-highlights 2–3 мин', '120 обработанных фото', 'Готовность 10 дней'],
  },
  {
    name: 'Свадьба',
    price: '55 000 ₽',
      ...
      <div className="container">
        <div className="text-center max-w-2xl mx-auto mb-14">
          ...
          <p className="text-lg text-muted-foreground">
            Прозрачные пакеты без скрытых доплат. Подберём под вашу дату, локацию и пожелания.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6 items-stretch">
          {packages.map((p) => (
            ...
            >
              ...
              <a
                href="#contacts"
                className={`inline-flex items-center justify-center gap-2 rounded-full px-6 py-3.5 font-display font-semibold transition-transform hover:-translate-y-0.5 ${
                  p.featured
