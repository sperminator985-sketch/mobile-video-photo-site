      ...
      <div className="container max-w-3xl py-10 sm:py-14">
        ...
        <Section title="1. Общие положения">
          <p>
            ...
            пользователей сайта студии «Айсберг-Видео» (далее — Сайт), оператором которого является
            Siberia Art Ltd. (далее — Оператор).
          </p>
          <p>
        ...
        <Section title="2. Какие данные мы собираем">
          <p>Оператор обрабатывает только те данные, которые пользователь указывает добровольно:</p>
        ...
        <Section title="5. Хранение и защита">
          <p>
            Данные хранятся не дольше, чем этого требуют цели обработки. Оператор принимает
        ...
        <Section title="6. Права пользователя">
          <p>
            ...
            обработку. Для этого достаточно направить обращение на электронную почту Оператора.
          </p>
        </Section>
